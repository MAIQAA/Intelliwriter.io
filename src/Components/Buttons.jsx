const Buttons = () => {
  return (
    <div className="relative w-full grid justify-items-center">
      <div className="absolute z-10 xl:top-72 lg:!top-36 md:top-36 top-20 flex md:flex-row flex-col lg:p-20 md:p-10 justify-center items-center gap-10 w-fit">
        <button className="flex items-center justify-start lg:gap-4 gap-2 border-2 rounded-full p-3 text-white">
          <div className="grid items-center justify-center lg:w-20 lg:h-20 h-12 w-12 bg-gradient-to-tr from-[#7A6896] via-[#311A5B] to-[#311A5B] border-2 border-white rounded-full">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
      ...
      <div className="relative w-full overflow-hidden min-h-screen 2xl:min-h-[800px] 2xl:w-3/4 z-20 opacity-20">
        ...
        <div className="absolute w-full h-full flex flex-row xl:gap-[110px] lg:!gap-[90px] md:gap-[65px] gap-[60px] justify-center ">
          ...
          <hr className="border-0 !w-px h-full text-white bg-white" />
          <hr className="border-0 !w-px h-full text-white bg-white" />
          <hr className="hidden md:block border-0 !w-px h-full text-white bg-white" />
          <hr className="hidden md:block border-0 !w-px h-full text-white bg-white" />
          <hr className="hidden md:block border-0 !w-px h-full text-white bg-white" />
          <hr className="hidden md:block border-0 !w-px h-full text-white bg-white" />
          <hr className="hidden md:block border-0 !w-px h-full text-white bg-white" />
        ...
        <div className="absolute w-full h-full flex flex-col xl:gap-[110px] lg:!gap-[90px] md:gap-[65px] gap-[60px] justify-center">
          ...
          <hr className="border-0 w-full h-px text-white bg-white" />
          <hr className="border-0 w-full h-px text-white bg-white" />
          <hr className="md:hidden block border-0 w-full h-px text-white bg-white" />
          <hr className="md:hidden block border-0 w-full h-px text-white bg-white" />
        </div>
      </div>
    </div>
